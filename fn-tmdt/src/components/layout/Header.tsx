...
export const Header: React.FC = () => {
  ...
  const [activeSearchTab, setActiveSearchTab] = useState<"shiro" | "manual">(
    "shiro",
  );
      ...
      <div className="flex items-center gap-8">
        ...
        >
          ...
          >
            <Search
              className={
                activeSearchTab === "shiro" && isSearchPanelOpen
                  ? "text-[#f65c88]"
                  : "text-on-surface-variant mr-2"
              }
              size={20}
            />
            <input
              className={`bg-transparent border-none focus:ring-0 text-sm w-full text-on-surface outline-none ${
                activeSearchTab === "shiro" && isSearchPanelOpen
                  ? "text-[#f65c88] font-medium placeholder-[#f65c88]"
                  : "placeholder-on-surface-variant/60"
              }`}
              placeholder={
                activeSearchTab === "shiro" && isSearchPanelOpen
                  ? t("header.shiroSearching")
